            ...
            if True:#__name__ == '__main__':
                ...
                if verbose:
                    ...
                    if cmd == channels + 1:
                        ...
                        raise IOError(f"A UPV_sorted.txt file for each round was NOT created")
                ...
                if verbose:
                    cmd = 'ls hveto_sorted*.txt -l | wc -l'
                    cmd = os.popen(cmd).read()
                    cmd = cmd[0:-1]
                    cmd = int(cmd)
                    if cmd == hveto_channels + 1:
                        print(f"-> Done (hveto_sorted.txt file for each round)")
                    else:
                        raise IOError(f"An hveto_sorted.txt file for each round was NOT created")
